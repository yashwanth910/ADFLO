        ...
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={() => setLightboxOpen(null)}>
          <div className="glass-card p-10 max-w-2xl w-full relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <img src="/lovable-uploads/26493cc3-4292-4b24-b1a6-c6ab42152007.jpg" alt="Arin Sharma" className="w-48 h-48 rounded-full object-cover" style={{ border: '8px solid rgba(255, 255, 255, 0.08)' }} />
      ...
      {lightboxOpen === 2 && (
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={() => setLightboxOpen(null)}>
          <div className="glass-card p-10 max-w-2xl w-full relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              {/* EDITABLE: Upload photo for lightbox */}
              <img src="/lovable-uploads/1c96f0e7-3a79-4508-9e1d-445106a5fa46.jpg" alt="Mira Patel" className="w-48 h-48 rounded-full object-cover" style={{ border: '8px solid rgba(255, 255, 255, 0.08)' }} />
              <div className="flex-1 space-y-4 text-center md:text-left">
                {/* EDITABLE: Name */}
      ...
      {lightboxOpen === 3 && (
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={() => setLightboxOpen(null)}>
          <div className="glass-card p-10 max-w-2xl w-full relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              {/* EDITABLE: Upload photo for lightbox */}
              <img src="/lovable-uploads/681cd3e4-6b8b-44db-93d8-c68adaa90f1a.jpg" alt="Dev Rao" className="w-48 h-48 rounded-full object-cover" style={{ border: '8px solid rgba(255, 255, 255, 0.08)' }} />
              <div className="flex-1 space-y-4 text-center md:text-left">
                {/* EDITABLE: Name */}
                <h3 className="text-3xl font-bold">Dev Rao</h3>
                {/* EDITABLE: Role */}
                <p className="text-lg text-muted-foreground">Colourist & Sound Designer</p>
                {/* EDITABLE: Bio */}
                <p className="text-muted-foreground">Colour grading + audio mix for cinematic deliverables.</p>
                {/* EDITABLE: Email link */}
                <a href="mailto:dev@flyn.example" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                  <Mail className="w-4 h-4" />
                  dev@flyn.example
                </a>
              </div>
      ...
      {lightboxOpen === 4 && (
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={() => setLightboxOpen(null)}>
          <div className="glass-card p-10 max-w-2xl w-full relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              {/* EDITABLE: Upload photo for lightbox */}
              <img src="/lovable-uploads/a847dff4-8af3-4e81-9ee8-893e3712bcd0.jpg" alt="Isha Kapoor" className="w-48 h-48 rounded-full object-cover" style={{ border: '8px solid rgba(255, 255, 255, 0.08)' }} />
              <div className="flex-1 space-y-4 text-center md:text-left">
                {/* EDITABLE: Name */}
      ...
      {lightboxOpen === 5 && (
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={() => setLightboxOpen(null)}>
          <div className="glass-card p-10 max-w-2xl w-full relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              {/* EDITABLE: Upload photo for lightbox */}
              <img src="/lovable-uploads/31767f83-d52d-4716-9be7-50849a304c92.jpg" alt="Karan Mehta" className="w-48 h-48 rounded-full object-cover" style={{ border: '8px solid rgba(255, 255, 255, 0.08)' }} />
              <div className="flex-1 space-y-4 text-center md:text-left">
                {/* EDITABLE: Name */}
      ...
      {lightboxOpen === 6 && (
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={() => setLightboxOpen(null)}>
          <div className="glass-card p-10 max-w-2xl w-full relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              {/* EDITABLE: Upload photo for lightbox */}
              <img src="/lovable-uploads/070cf02d-90f1-4219-97d8-adbb43eaf3ce.jpg" alt="Riya Singh" className="w-48 h-48 rounded-full object-cover" style={{ border: '8px solid rgba(255, 255, 255, 0.08)' }} />
              <div className="flex-1 space-y-4 text-center md:text-left">
                {/* EDITABLE: Name */}
