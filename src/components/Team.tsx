          ...
          <div className="glass-card p-10 max-w-2xl w-full relative" onClick={e => e.stopPropagation()}>
            ...
            border: '8px solid rgba(255, 255, 255, 0.08)'
              ...
              <div className="flex-1 space-y-4 text-center md:text-left">
                ...
                {/* EDITABLE: Bio */}
                <p className="text-muted-foreground">​Supervising the graphic design processes and managing the outputs. </p>
                {/* EDITABLE: Email link */}
          ...
          <div className="glass-card p-10 max-w-2xl w-full relative" onClick={e => e.stopPropagation()}>
            ...
            border: '8px solid rgba(255, 255, 255, 0.08)'
              ...
              <div className="flex-1 space-y-4 text-center md:text-left">
                ...
                {/* EDITABLE: Bio */}
                <p className="text-muted-foreground">Planning what content works best for the client's goals.</p>
                {/* EDITABLE: Email link */}
