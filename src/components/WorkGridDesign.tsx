...
const WorkGridDesign = ({
  ...
  return <>
        ...
        <div className="container mx-auto">
          ...
          <div className="relative">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="glass-card aspect-video group hover:-translate-y-2 hover:shadow-xl hover:shadow-muted/10 transition-all duration-300 cursor-pointer relative overflow-hidden rounded-xl" onClick={() => openModal(1, "/lovable-uploads/6ad463dc-ea13-45f1-b57a-cb5c0aac1eff.jpg")}>
                {/* EDITABLE: Image - This same image shows in the modal */}
                <img alt="Design Project 1" className="absolute inset-0 w-full h-full object-cover" src="/lovable-uploads/e1c96da1-122d-4310-a5ee-e9904cb69a21.jpg" />
              ...
              <div className="glass-card aspect-video group hover:-translate-y-2 hover:shadow-xl hover:shadow-muted/10 transition-all duration-300 cursor-pointer relative overflow-hidden rounded-xl" onClick={() => openModal(2, "/placeholder.svg")}>
                <img alt="Design Project 2" className="absolute inset-0 w-full h-full object-cover" src="/lovable-uploads/2f17df63-a1be-4dd3-926a-38a3b412e546.jpg" />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
              ...
              <div className="glass-card aspect-video group hover:-translate-y-2 hover:shadow-xl hover:shadow-muted/10 transition-all duration-300 cursor-pointer relative overflow-hidden rounded-xl" onClick={() => openModal(3, "/placeholder.svg")}>
                <img alt="Design Project 3" className="absolute inset-0 w-full h-full object-cover" src="/lovable-uploads/dcaafb1f-ff91-4efa-b2f7-c5f4983003b2.jpg" />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
              ...
              <div className="glass-card aspect-video group hover:-translate-y-2 hover:shadow-xl hover:shadow-muted/10 transition-all duration-300 cursor-pointer relative overflow-hidden rounded-xl" onClick={() => openModal(4, "/placeholder.svg")}>
                <img alt="Design Project 4" className="absolute inset-0 w-full h-full object-cover" src="/lovable-uploads/704b5a20-0183-4daa-85e6-9a97085c68e1.jpg" />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
              ...
              <div className="glass-card aspect-video group hover:-translate-y-2 hover:shadow-xl hover:shadow-muted/10 transition-all duration-300 cursor-pointer relative overflow-hidden rounded-xl" onClick={() => openModal(5, "/placeholder.svg")}>
                <img alt="Design Project 5" className="absolute inset-0 w-full h-full object-cover" src="/lovable-uploads/b181ccaf-ead2-41a5-92c0-8dbe69c7fae5.jpg" />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
              ...
              <div className="glass-card aspect-video group hover:-translate-y-2 hover:shadow-xl hover:shadow-muted/10 transition-all duration-300 cursor-pointer relative overflow-hidden rounded-xl" onClick={() => openModal(6, "/placeholder.svg")}>
                <img alt="Design Project 6" className="absolute inset-0 w-full h-full object-cover" src="/lovable-uploads/13604ad6-fd68-446a-a63a-f600535d29a3.jpg" />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
              ...
              <div className="glass-card aspect-video group hover:-translate-y-2 hover:shadow-xl hover:shadow-muted/10 transition-all duration-300 cursor-pointer relative overflow-hidden rounded-xl" onClick={() => openModal(7, "/placeholder.svg")}>
                <img alt="Design Project 7" className="absolute inset-0 w-full h-full object-cover" src="/lovable-uploads/2037c3bd-dacc-430a-bd14-f6caafeb382e.jpg" />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
              ...
              <div className="glass-card aspect-video group hover:-translate-y-2 hover:shadow-xl hover:shadow-muted/10 transition-all duration-300 cursor-pointer relative overflow-hidden rounded-xl" onClick={() => openModal(8, "/placeholder.svg")}>
                <img alt="Design Project 8" className="absolute inset-0 w-full h-full object-cover" src="/lovable-uploads/120b966a-2478-4876-9624-e343c2c9c626.jpg" />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
              ...
              <div className="glass-card aspect-video group hover:-translate-y-2 hover:shadow-xl hover:shadow-muted/10 transition-all duration-300 cursor-pointer relative overflow-hidden rounded-xl" onClick={() => openModal(9, "/placeholder.svg")}>
                <img alt="Design Project 9" className="absolute inset-0 w-full h-full object-cover" src="/lovable-uploads/46584cef-e925-4141-8951-3fd095aea5d8.jpg" />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
      ...
      {modalOpen !== null && <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={closeModal}>
          <div className="relative max-w-5xl w-full flex flex-col items-center" onClick={e => e.stopPropagation()}>
            ...
            <img src={modalImageSrc} alt={`Design Project ${modalOpen} Full`} className="max-w-full max-h-[75vh] object-contain rounded-xl" />
