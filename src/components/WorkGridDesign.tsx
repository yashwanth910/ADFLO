  ...
  return <>
      ...
      {modalOpen === 10 && <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={closeModal}>
          <div className="relative max-w-5xl w-full flex flex-col items-center" onClick={e => e.stopPropagation()}>
            ...
            <img alt="Design Project 10 Full" className="max-w-full max-h-[75vh] object-contain rounded-xl" src="https://github.com/yashwanth910/portfolio-media/releases/download/v1/audition.poster.png" />
            <div className="glass-card mt-4 p-4 rounded-lg max-w-2xl text-center">
      ...
      {modalOpen === 11 && <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={closeModal}>
          <div className="relative max-w-5xl w-full flex flex-col items-center" onClick={e => e.stopPropagation()}>
            ...
            <img alt="Design Project 11 Full" className="max-w-full max-h-[75vh] object-contain rounded-xl" src="https://github.com/yashwanth910/portfolio-media/releases/download/v1/E-80.jpg" />
            <div className="glass-card mt-4 p-4 rounded-lg max-w-2xl text-center">
      ...
      {modalOpen === 12 && <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={closeModal}>
          <div className="relative max-w-5xl w-full flex flex-col items-center" onClick={e => e.stopPropagation()}>
            ...
            <img alt="Design Project 12 Full" className="max-w-full max-h-[75vh] object-contain rounded-xl" src="https://github.com/yashwanth910/portfolio-media/releases/download/v1/rat.logo.jpeg" />
            <div className="glass-card mt-4 p-4 rounded-lg max-w-2xl text-center">
