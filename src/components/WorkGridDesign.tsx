  ...
  return <>
      ...
      {modalOpen === 10 && <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={closeModal}>
          <div className="relative max-w-5xl w-full flex flex-col items-center" onClick={e => e.stopPropagation()}>
            ...
            <img alt="Design Project 10 Full" className="max-w-full max-h-[75vh] object-contain rounded-xl" src="/lovable-uploads/b9b38bc8-bfc8-4040-b6f0-db906487dfe9.png" />
            <div className="glass-card mt-4 p-4 rounded-lg max-w-2xl text-center">
      ...
      {modalOpen === 11 && <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={closeModal}>
          <div className="relative max-w-5xl w-full flex flex-col items-center" onClick={e => e.stopPropagation()}>
            ...
            <img alt="Design Project 11 Full" className="max-w-full max-h-[75vh] object-contain rounded-xl" src="/lovable-uploads/cb067773-def1-4ab8-ab2a-83db5427f70b.jpg" />
            <div className="glass-card mt-4 p-4 rounded-lg max-w-2xl text-center">
      ...
      {modalOpen === 12 && <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-6" onClick={closeModal}>
          <div className="relative max-w-5xl w-full flex flex-col items-center" onClick={e => e.stopPropagation()}>
            ...
            <img alt="Design Project 12 Full" className="max-w-full max-h-[75vh] object-contain rounded-xl" src="/lovable-uploads/1fba53e9-8a7b-4a9f-9879-4c9f7db52d3e.jpg" />
            <div className="glass-card mt-4 p-4 rounded-lg max-w-2xl text-center">
